...
- Mauga's 6v6 armor is already 100, unlike the unqualified 150-to-125 note. The 5v5 change is applied and 6v6 remains 100 pending mode confirmation. Both groups record dual-gun spread as 0.85 rather than the official old 4 degrees; the new 5-degree value is applied without rewriting earlier history.
