...
new_property_name = "Charge damage"
new_value = 120
process_json_files(folder_path, 'heroes/damage/Ashe/abilities/B.O.B/Charge damage', new_property_name, new_value, rename=False)