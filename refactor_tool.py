...
new_property_name = "Turret recovery time"
new_value = 0.256
process_json_files(folder_path, 'heroes/damage/Torbjörn/abilities/Deploy Turret/Turret recovery time', new_property_name, new_value, rename=False)