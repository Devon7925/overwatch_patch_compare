...
new_property_name = "Startup cast time"
new_value = 0.6
process_json_files(folder_path, 'heroes/tank/Sigma/abilities/Gravitic Flux/Startup cast time', new_property_name, new_value, rename=False)