...
new_property_name = "Invulnerability duration"
new_value = 0.25
process_json_files(folder_path, 'heroes/support/Kiriko/abilities/Swift Step/Invulnerability duration', new_property_name, new_value, rename=False)