...
new_property_name = "freezes soul in place"
new_value = True
process_json_files(folder_path, 'heroes/support/Mercy/abilities/Resurrect/freezes soul in place', new_property_name, new_value, rename=False)