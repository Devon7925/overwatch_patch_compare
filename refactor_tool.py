...
new_property_name = "Flight speed boost"
new_value = 30
process_json_files(folder_path, 'heroes/tank/Sigma/abilities/Gravitic Flux/Flight speed boost', new_property_name, new_value, rename=False)