...
new_property_name = "Pull delay"
new_value = 0.3
process_json_files(folder_path, 'heroes/tank/Roadhog/abilities/Chain Hook/Pull delay', new_property_name, new_value, rename=False)