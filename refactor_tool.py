...
new_property_name = "Interact range"
new_value = 1.5
process_json_files(folder_path, 'heroes/damage/Symmetra/abilities/Teleporter/Interact range', new_property_name, new_value, rename=False)