...
new_property_name = "Self healing per second"
new_value = 10
process_json_files(folder_path, 'heroes/support/Lúcio/abilities/Crossfade/Self healing per second', new_property_name, new_value, rename=False)