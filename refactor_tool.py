...
new_property_name = "Hack damage multiplier"
new_value = 2
process_json_files(folder_path, 'heroes/damage/Sombra/abilities/Virus/Hack damage multiplier', new_property_name, new_value, rename=False)