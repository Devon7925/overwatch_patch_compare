...
new_property_name = "Weapon swap time"
new_value = 0.25
process_json_files(folder_path, 'heroes/support/Mercy/general/Weapon swap time', new_property_name, new_value, rename=False)